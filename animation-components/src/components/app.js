...
export default class App extends Component {
            ...
            return (
                <li className="list-group-item" key={item}>
                    ...
                    <button
                        ...
                        className="remove btn btn-danger">Remove
                    </button>
                </li>
            );
        });
    ...
    render() {
        ...
        const transitionOptions = {
            transitionName: 'fade',
            transitionEnterTimeout: 500,    // How long animation takes when element is added from the list
            transitionLeaveTimeout: 500     // How long animation takes when element is removed from the list
        };
